...
public class MyCircle {
	...
	public static MyCircle getCercleCirconscrit(MyPoint a, MyPoint b, MyPoint c) {
		...
		if( Math.abs(a.getY() -  c.getY()) < 0.01) {
			medAB = (new MySegment(a, b)).getEquationMediatrice();
			medBC = (new MySegment(b, c)).getEquationMediatrice();
		} else 	if( Math.abs(b.getY() -  c.getY()) < 0.01) {
			medAB = (new MySegment(b, a)).getEquationMediatrice();
			medBC = (new MySegment(a, c)).getEquationMediatrice();
		} else { // b a
			medAB = (new MySegment(b, c)).getEquationMediatrice();
			medBC = (new MySegment(c, a)).getEquationMediatrice();
		}
...
//		System.out.println("[FIN DEBUG]");
	...
	public static MyCircle getCercleCirconscritBack(MyPoint a, MyPoint b, MyPoint c) {
	...
	public boolean collision(MyCircle c) {
		return this.centre.distance(c.getCentre()) <= (c.rayon + this.rayon);
	}
