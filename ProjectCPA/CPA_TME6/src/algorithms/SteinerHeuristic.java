...
public class SteinerHeuristic {
	...
	public static Tree2D calcSteinerHeuristic(ArrayList<Point> points, int edgeThreshold, ArrayList<Point> hitPoints){
		...
		ArrayList<Edge> edgesBetweenHitPoints = Kruskal2.calculKruskal(hitPoints);//algorithmeKruskal(hitPoints);
		...
		return Kruskal2.EdgeToTree(Kruskal2.calculKruskal(path));		
	}
	...
	public static Tree2D steinerBarycentre(ArrayList<Point> points, int edgeThreshold, ArrayList<Point> hitPoints){
